...
class MainScene3ButtonUpdate extends Component {
    constructor(parent) {
        super(parent);
    ...
    update() {
        let mainScene3Update = Game.findByType("MainScene3TextGameObject")[0];
        let mainScene3UpdateComponent = mainScene3Update.getComponent("MainScene3Update");
        ...
        if (Input.getMouseButtonDown(0)) {
            ...
            if (mx > rectangle.x || mx < rectangle.x + rectangle.w && my > rectangle.y || my < rectangle.y + rectangle.h) {
                mainScene3UpdateComponent.stringIndex++;
                if (mainScene3UpdateComponent.stringIndex == 0){
                ...
                if (mainScene3UpdateComponent.stringIndex == 1) {
                ...
                if (mainScene3UpdateComponent.stringIndex== 4){
                    var gameObject2 = Game.findByName("cindyName")[0];
                    gameObject2.visible = true;

                    var gameObject2 = Game.findByName("armoredKnight")[0];
                    gameObject2.visible = false;
          
                }
                if (mainScene3UpdateComponent.stringIndex== 5){
                    var gameObject2 = Game.findByName("cindyName")[0];
                    gameObject2.visible = false;
                ...
                // if (mainScene3UpdateComponent.stringIndex == 6){
                //     var cindyShowText = Game.findByName("cindyName")[0]
                ...
                // }
                if (mainScene3UpdateComponent.stringIndex == 7){
                    var cindyShowText = Game.findByName("cindyName")[0]
                    cindyShowText.visible=false;
                ...
                if (mainScene3UpdateComponent.stringIndex == 9){
                    var cindyShowText = Game.findByName("cindyName")[0]
                    cindyShowText.visible=true;
                ...
                // if (mainScene3UpdateComponent.stringIndex == 10){
                //     var cindyShowText = Game.findByName("cindyName")[0]
                //     cindyShowText.visible=false;
                ...
                //     gameObject.visible=true;
                // }
                if (mainScene3UpdateComponent.stringIndex == 11){
                    var cindyShowText = Game.findByName("cindyName")[0]
                    cindyShowText.visible=true;
                ...
                // if (mainScene3UpdateComponent.stringIndex == 13){
                //     var cindyShowText = Game.findByName("cindyName")[0]
                //     cindyShowText.visible=false;
                ...
                //     gameObject.visible=true;
                // }
                // if (mainScene3UpdateComponent.stringIndex == 17){
                //     var cindyShowText = Game.findByName("cindyName")[0]
                //     cindyShowText.visible=true;
                ...
                //     gameObject.visible=false;
                // }
                if (mainScene3UpdateComponent.stringIndex == 15){
                    var cindyShowText = Game.findByName("cindyName")[0]
                    cindyShowText.visible=false;
                ...
                if (mainScene3UpdateComponent.stringIndex == 18){
                    var cindyShowText = Game.findByName("cindyName")[0]
                    cindyShowText.visible=true;
...
export default MainScene3ButtonUpdate;
